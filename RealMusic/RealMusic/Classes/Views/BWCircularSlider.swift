...
struct Config {
    ...
    static let TB_LINE_WIDTH:CGFloat = 5.0
    static let TB_FONTSIZE:CGFloat = 5.0
...
//        addSubview(textField!)
    ...
    override func drawRect(rect: CGRect){
        ...
        let startColorComps:UnsafePointer<CGFloat> = CGColorGetComponents(UIColor.orangeColor().CGColor);
        let endColorComps:UnsafePointer<CGFloat> = CGColorGetComponents(UIColor.orangeColor().CGColor);
...
//        println("circle: \(angle)")
  ...
  func drawDuration(ctx:CGContextRef){
